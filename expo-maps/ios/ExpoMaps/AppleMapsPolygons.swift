...
class AppleMapsPolygons: Polygons {
  ...
  func setPolygons(polygonObjects: [PolygonObject]) {
    ...
    for polygonObject in polygonObjects {
      ...
      polygon.strokeWidth = polygonObject.strokeWidth!
      polygon.strokePattern = strokePatternToLineDashPattern(pattern: polygonObject.strokePattern, width: polygon.strokeWidth)
